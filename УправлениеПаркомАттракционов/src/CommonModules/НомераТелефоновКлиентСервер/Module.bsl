...
// Преобразует номер телефона из любого в нормализованный для быстрого поиска.
// Состоит из 11 цифр и начинается с 7
// 
// Параметры:
...
//  Строка
Функция НомализованныйНомерТелефона(Телефон, ВызыватьИсключение = Ложь) Экспорт
